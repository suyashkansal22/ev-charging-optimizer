...
export const mockStations: Station[] = [
  {
    station_id: "Charging Station Sector 5",
  ...
  {
    station_id: "Charging Station Sector 15",
  ...
  {
    station_id: "Charging Station Sector 17",
  ...
  {
    station_id: "Charging Station Sector 9",
  ...
  {
    station_id: "Charging Station Sector 22",
    station_latitude: 30.7410,
    station_longitude: 76.7620,
    transformer_id: "TX-02",
  ...
  {
    station_id: "Charging Station Sector 20",
    station_latitude: 30.7390,
    station_longitude: 76.7900,
    transformer_id: "TX-03",
    number_of_chargers: 8,
    available_chargers: 1,
  ...
  {
    station_id: "Charging Station Sector 25",
    station_latitude: 30.7200,
    station_longitude: 76.7850,
    transformer_id: "TX-01",
...
export const mockAssignments: Assignment[] = [
  { vehicle_id: "Tesla EV3", station_id: "Charging Station Sector 5", time_slot: 1, est_cost: 486.2 },
  { vehicle_id: "Tata Tiago", station_id: "Charging Station Sector 15", time_slot: 3, est_cost: 351.4 },
  { vehicle_id: "BYD", station_id: "Charging Station Sector 17", time_slot: 2, est_cost: 169.8 }
];
